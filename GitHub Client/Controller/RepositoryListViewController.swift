    ...
    private func fetchContent() {
        ...
        githubService.list(page: fetchPage) { [weak self] (listResult) in
            ...
            case .success(let repositories):
                ...
                self?.repositories.value.append(contentsOf: repositories.map({ (repository) -> RepositoryCellViewModel in
...
extension RepositoryListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let repositoryCell = tableView.dequeueReusableCell(withIdentifier: viewModel.cellIdentifier) as? RepositoryTableViewCell {
            repositoryCell.bind(viewModel)
